<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.teachers') }}" class="text-m text-white hover:text-gray-400">Back</a>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.teachers.update', $teacher->id) }}">
                        ...
                        <div class="flex items-center justify-between">
                            <a href="{{ route('admin.teachers') }}" class="text-gray-600 hover:text-gray-900">Cancel</a>
