                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($subjects as $subject)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $subjects->firstItem() + $loop->index }}</td>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500">{{ $subject->description ?? 'N/A' }} </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('admin.subjects.edit', $subject->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
